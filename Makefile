...
FILES = main.c builtins/cd.c builtins/cd_utils.c builtins/echo.c builtins/env.c builtins/exit.c \
	...
	execution/ft_pipe.c execution/redirections.c execution/utils.c execution/error_handle.c \
	extra/env.c extra/signals.c libft/ft_atoi.c libft/ft_dbl_strlen.c libft/ft_env_lstnew.c \
	libft/ft_envadd_back.c libft/ft_envsplit.c libft/ft_isdigit.c libft/ft_itoa.c libft/ft_lstlast.c \
